...
- db90a3a: Show the current startup stage and available diagnostics after thirty seconds without progress, without automatically stopping work. Verify Computer Use updates against the extension's shared native protocol version.
...
- Updated dependencies [01c926c]
- Updated dependencies [9039517]
- Updated dependencies [c6ee82d]
- Updated dependencies [b01809e]
- Updated dependencies [ba2fd8f]
- Updated dependencies [46136ab]
- Updated dependencies [942df0d]
- Updated dependencies [bbd22ac]
- Updated dependencies [f13cda7]
- Updated dependencies [ba473d9]
  - @moxxy/cli@0.41.0
  - @moxxy/sdk@0.41.0
  - @moxxy/plugin-stt-whisper-codex@0.41.0
  - @moxxy/desktop-host@0.14.19
  - @moxxy/chat-model@0.4.10
  - @moxxy/client-core@0.13.28
  - @moxxy/client-platform-web@0.1.67
  - @moxxy/desktop-ipc-contract@0.14.24
  - @moxxy/ipc-server-ws@0.1.66
  - @moxxy/plugin-channel-mobile@0.41.0
  - @moxxy/plugin-vault@0.41.0
  - @moxxy/runner@0.2.53
  - @moxxy/workflows-builder@0.1.50

## 0.39.3

### Patch Changes

- 6733381: Fix macOS installer code signing. electron-builder 26.15.3 passed the `.p12` password to `security set-key-partition-list`, which expects the temporary keychain's own password, so signing failed with "The user name or passphrase you entered is not correct" no matter how the certificate secrets were configured. Pin the electron-builder toolchain to 26.16.1, where that is fixed.
...
- Updated dependencies [7e47604]
  - @moxxy/sdk@0.40.0
  - @moxxy/cli@0.40.0
  - @moxxy/chat-model@0.4.9
  - @moxxy/client-core@0.13.27
  - @moxxy/client-platform-web@0.1.66
  - @moxxy/desktop-host@0.14.18
  - @moxxy/desktop-ipc-contract@0.14.23
  - @moxxy/ipc-server-ws@0.1.65
  - @moxxy/plugin-channel-mobile@0.40.0
  - @moxxy/plugin-stt-whisper-codex@0.40.0
  - @moxxy/plugin-vault@0.40.0
  - @moxxy/runner@0.2.52
  - @moxxy/workflows-builder@0.1.49
