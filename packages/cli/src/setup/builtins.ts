...
import { virtualOfficeChannelPlugin } from '@moxxy/plugin-channel-virtual-office';
...
export const BUILTIN_REQUIREMENT_DECISIONS: Readonly<Record<string, BuiltinRequirementDecision>> = {
  ...
  '@moxxy/plugin-channel-virtual-office': { hardRequirements: false, reason: 'office surface is standalone; token auto-generated' },
...
export function buildBuiltinsCore(args: BuildBuiltinsArgs): BuiltBuiltinsCore {
  ...
  const entries: BuiltinEntry[] = [
    ...
    { name: '@moxxy/plugin-channel-virtual-office', plugin: virtualOfficeChannelPlugin },
