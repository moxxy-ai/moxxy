 ...
 * approved/denied/result events directly on `ctx`. Mirrors the dispatch
 * helper in mode-plan-execute / mode-tool-use; kept local to avoid a
 * cross-package import for a ~100-line helper.
 */
